...
We are 95% confident that in the population of people similar to those in this study, a 1 unit increase in mcs while holding fixed the substance being treated is associated with a decrease in the square root of the number of alcoholic drinks consumed of between about -0.033 and -0.003.  For 95% of samples, an interval computed in this way would contain the slope of the lines in the population.
