 ...
 * **In Class**, we will do the following:
    ...
    * Discuss material from Sections 5.2 and 6.2
 * **After class**, please do the following:
    * Work on **Homework 2**, due Friday Feb 8.
 ...
 * **In Class**, we will do the following:
    ...
    * Finish material from Sections 5.2 and 6.2, or move on to Section 5.3
 * **After class**, please do the following:
    * Work on **Homework 2**, due Friday Feb 8.
 ...
 * **In class**, we will do the following:
    ...
    * Discuss material from Sections 5.3 and 5.4
"
  )
```
...
#### Mon, Feb 11
 * **In class**, we will do the following:
    * **Quiz** on material from Chapters 1, 2, or Sections 5.2 and 6.2
    * Discuss material from Sections 5.3 and 5.4, or move on to Section 5.5 and Chapter 3
