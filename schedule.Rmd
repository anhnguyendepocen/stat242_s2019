 ...
 * **In class**, we will do the following:
    * **Quiz**
    * Finish material from Section 5.5 and Chapter 3, or move on to Sections 6.3 and parts of 6.4

#### Wed, Feb 27
 * **In class**, we will do the following:
    * **Quiz**
    * Section 6.3 and parts of 6.4

#### Fri, Mar 1
 * **In class**, we will do the following:
    * **Quiz**
    * Section 6.3 and parts of 6.4, or else move on to Chapter 7
"
  )
```
