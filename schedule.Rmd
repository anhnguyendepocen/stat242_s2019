 ...
 * **In class**, we will do the following:
    * **Quiz**
    * A couple more minor topics from Chapter 8: refining our view of equal standard deviations, handling outliers (we will revisit in Chapter 11), and checking normality
