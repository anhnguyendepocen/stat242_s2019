...
```{r, echo = FALSE, results='asis'}
make_week_box("week10", TRUE, "Week 10: Mar 25 -- 29",
"
 ...
 * **In Class**, we will do the following:
    * **Quiz**
    * Chapters 9 and 10: Interactions between a categorical and quantitative variable (2 non-parallel lines)
"
  )
```
 ...
 * **In Class**, we will do the following:
    * **Quiz**
    * Chapters 9 and 10: Regresion with two lines, or two quantitative explanatory variables

#### Tue, Apr 3
 * **In Class**, we will do the following:
    * **Quiz**
    * Chapters 9 and 10: Two quantitative explanatory variables

#### Fri, Apr 5
 * **In Class**, we will do the following:
    * **Quiz**
    * Chapters 9 and 10: Multiple quantitative or categorical explanatory variables
"
  )
```
