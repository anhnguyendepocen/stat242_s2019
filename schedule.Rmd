 ...
 * **In class**, we will do the following:
    ...
    * Chapter 7
        ...
        * Point estimates and confidence intervals for the mean response at a given value of the explanatory variable: [pdf](materials/20190301_predict.pdf)
        * Start Lab 7
 * **After class** please work on the following:
    * **Homework 5** due Friday Mar 1
"
 ...
 * **In class**, we will do the following: Start thinking about residuals.  Chapters 7 and 8
    * **No Quiz**
    * Residuals, model fit by least squares, prediction intervals
    * Model Checking by residuals plots

#### Wed, Mar 20
 * **In class**, we will do the following: Chapter 8
    * **Quiz**
    * Model checking by residuals plots, start on transformations for simple linear regression
