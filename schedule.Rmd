...
#### Mon, Jan 28
 * **In Class**, we will do the following: Sections 2.1 and 2.2
...
#### Wed, Jan 30
 * **In Class**, we will do the following: Sections 2.3 and 2.4
    * $t$-based inference for difference between two means with unpaired data.
    * **Quiz**
 * **After class**, please do the following:
 ...
 * **In Class**, we will do the following:
    * Finish any remaining material from Mon and Wed
 * **After class**, please do the following:
