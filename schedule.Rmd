...
"
* Introduction; review of topics from probability and calculus; getting started with R
...
#### Fri, Jan 25
 * **In class**, we will work on: Sections 2.1 and 2.2
...
Simple random samples, sampling distributions, bias, variance, mean squared error, a first look at confidence intervals.

(See Stat 344SM, survey sampling, for the rest of Chapter 7 and much more)
